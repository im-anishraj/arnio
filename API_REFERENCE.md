...
| **Conversion**        | [`from_pandas`](#from_pandas) ï [`to_pandas`](#to_pandas) ï [`concat`](#concat)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
Concatenates a list of `ArFrame` objects row-wise.

```python
merged_frame = ar.concat(frames, ignore_index=True)
```
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| `frames` | `list[ArFrame]` | required | A non-empty list of ArFrames to merge |
| `ignore_index` | `bool` | `True` | Must be `True` (ArFrame does not support index columns) |

#### Raises

| Error | When |
|-------|------|
| `TypeError` | `frames` is not a list or contains elements that are not `ArFrame` instances |
| `ValueError` | `frames` list is empty, or `ignore_index` is `False` |
| `ValueError` | Column names or order do not match across the input frames |
| `TypeError` | Column dtypes do not match exactly across the input frames |
