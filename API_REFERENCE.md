...
| **Schema Validation** | [`Schema`](#schema) • [`Field`](#field) • [`validate`](#validate) • [`ValidationResult`](#validationresult) • [`ValidationIssue`](#validationissue) • [`Int64`](#int64) • [`Float64`](#float64) • [`String`](#string) • [`Bool`](#bool) • [`Email`](#email) • [`URL`](#url) • [`CountryCode`](#countrycode) • [`DateTime`](#datetime) • [`IPAddress`](#ipaddress) • [`JSON`](#json)                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| <a name="ipaddress"></a>**IPAddress**     | Validates IPv4 and IPv6 string addresses.       |
| <a name="json"></a>**JSON**               | Validates correct JSON formatting.              |
